    ...
    <div class="container" style="margin-top:26px;padding-left:0px;height:600px">
				...
				<div class="col-md-10" style="height:100%;background-color:#fff;padding-top:70px">
                        <div class="row" style="text-align:center;">
                            <form name="frmMain" id="frmMain" class="form-horizontal" role="form" method="post" action="__URL__/AddCustomer">
								<div class="form-group" id="checkID">
									<div class="col-md-4 col-md-offset-2">
										<input type="text" class="form-control input input_regular" id="user_name" name="user_name" value="<?php echo ($customer["user_name"]); ?>" placeholder="请填写用户名" required>
									</div>
									<div class="col-md-4" style="margin-left:-18px">
										  <input type="text" class="form-control input input_regular" id="user_passwd" name="user_passwd" value="<?php echo ($customer["user_passwd"]); ?>" placeholder="请填写密码" required>
									</div>
								</div>
								<div class="form-group" id="checkID">
									<div class="col-md-8 col-md-offset-2">
										  <input type="text" class="form-control input input_regular" id="user_org" name="user_org" value="<?php echo ($customer["user_org"]); ?>" placeholder="请填写单位" style="width:97%">
									</div>
								</div>
								<div class="form-group" id="checkID">
									<div class="col-md-4 col-md-offset-2">
										<input type="text" class="form-control input input_regular" id="office_phone" name="office_phone" value="<?php echo ($customer["office_phone"]); ?>" placeholder="请填写电话" required>
									</div>
									<div class="col-md-4" style="margin-left:-18px">
										  <input type="text" class="form-control input input_regular" id="user_duty" name="user_duty" value="<?php echo ($customer["user_duty"]); ?>" placeholder="请填写职务" required>
									</div>
								</div>
								<div class="form-group" id="checkID">
									<div class="col-md-8 col-md-offset-2">
										  <textarea class="form-control" id="memo" name="memo" value="<?php echo ($customer["memo"]); ?>" rows="4" placeholder="请填写备注" style="width:97%;border-radius:0px"></textarea>
									</div>
								</div>
								<div class="form-group" id="checkID">
									<div class="col-md-8 col-md-offset-2" style="text-align:right;padding-right:32px">
										  <a type="button" class="btn red-btn" href="__APP__/Customer/index" style="width:150px">返回</a>
										  <button type="submit" class="btn grn-btn" style="width:150px">保存</button>
									</div>
								</div>
							</form>
					</div>
